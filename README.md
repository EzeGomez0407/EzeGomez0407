...
- Desarrollador Web Frontend – Proyecto SPA para Iglesia.
  ...
  Desarrollo del frontend con foco en organización de componentes, diseño responsive y experiencia de usuario.
  Next.js-Tailwind

- Desarrollador Web Full Stack Jr. – Proyecto para Constructora.
  Diseño y desarrollo de una aplicación web para una constructora, orientada al control y seguimiento de herramientas y obras.
